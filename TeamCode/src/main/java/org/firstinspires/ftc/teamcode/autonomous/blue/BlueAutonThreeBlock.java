        ...
        if (pos == 3) {
            ...
            robot.follow(0.2,0.7,
                    robot.path(Math.PI/2)
                            ...
                            .splineTo(new Pose2d(new Vector2d(-29,51).rotated(-Math.PI/2),Math.toRadians(300)))
                            .build(),
            ...
            robot.follow(0.2,0.7,
                    robot.path(Math.PI/2)
                            ...
                            .splineTo(new Pose2d(new Vector2d(-40,-24).rotated(-Math.PI/2),Math.toRadians(0))) // 72-18-9-3
                            .splineTo(new Pose2d(new Vector2d(-40,36).rotated(-Math.PI/2),Math.toRadians(0)))
                            .splineTo(new Pose2d(new Vector2d(-29,38).rotated(-Math.PI/2),Math.toRadians(300)))
                            .build(),
                    new double[]{90,90,90,180}
            );
        }
        ...
        if (pos == 3) {
            ...
            robot.follow(0.25,0.9,
                    robot.path(Math.PI/2)
                            ...
                            .splineTo(new Pose2d(new Vector2d(-24,-48-8+2).rotated(-Math.PI/2),Math.toRadians(270)))
                            .build(),
            ...
            robot.follow(0.25,0.9,
                    robot.path(Math.PI/2)
                            .splineTo(new Pose2d(new Vector2d(-40,36).rotated(-Math.PI/2),Math.toRadians(180)))
                            .splineTo(new Pose2d(new Vector2d(-40,-24).rotated(-Math.PI/2),Math.toRadians(180)))
                            .splineTo(new Pose2d(new Vector2d(-22,-48+2).rotated(-Math.PI/2),Math.toRadians(270)))
                            .build(),
                    new double[]{180,180,180}
            );
            robot.follow(0.3,0.5,
        ...
        if(pos == 1) {
            ...
            robot.follow(0.1,0.8,
                    robot.path(0)
                            ...
                            .splineTo(new Pose2d(new Vector2d(-31,46).rotated(-Math.PI/2),Math.toRadians(270)))
                            .splineTo(new Pose2d(new Vector2d(-28,46).rotated(-Math.PI/2),Math.toRadians(270)))
                            .build(),
                    new double[]{90,90,90}
            );
            robot.hook.hookDown();
