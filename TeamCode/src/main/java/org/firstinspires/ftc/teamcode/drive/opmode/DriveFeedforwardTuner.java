...
//        telemetry.update();
        ...
        Log.d("literallywhatever?!", rampResult.kV + "\t" + rampResult.kStatic + "\t" + rampResult.rSquare);
        TelemetryPacket packet = new TelemetryPacket();
        packet.put("kv", rampResult.kV);
        packet.put("kStatic", rampResult.kStatic);
        packet.put("rSquare", rampResult.rSquare);
