...
public class RedAutonTwoBlock extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        MohanBot robot = new MohanBot(hardwareMap, this, new Pose2d(63, -2* Constants.FieldConstants.TILE_WIDTH + BOT_WIDTH/2, Math.toRadians(90)));
        ...
        if (pos == 1) {
            robot.moveTo(new Vector2d(1.5* Constants.FieldConstants.TILE_WIDTH, -1.5* Constants.FieldConstants.TILE_WIDTH), 50,DEFAULT_STRAFE_POWER,DEFAULT_ROTATION_POWER);
            robot.intake.intakeIn();
            robot.strafeTo(new Vector2d(20, -1* Constants.FieldConstants.TILE_WIDTH),DEFAULT_STRAFE_POWER);
        } else if (pos == 2) {
            robot.moveTo(new Vector2d(1.5* Constants.FieldConstants.TILE_WIDTH, -1.5* Constants.FieldConstants.TILE_WIDTH-4), 50, DEFAULT_STRAFE_POWER,DEFAULT_ROTATION_POWER);
            robot.intake.intakeIn();
        ...
        robot.intake.intakeStop();
        robot.moveTo(new Vector2d(40, 24), 90,DEFAULT_STRAFE_POWER,DEFAULT_ROTATION_POWER);
        ...
        robot.moveTo(new Vector2d(40,20), 90, DEFAULT_STRAFE_POWER, DEFAULT_ROTATION_POWER);
