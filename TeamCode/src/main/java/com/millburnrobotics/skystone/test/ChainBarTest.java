...
//
//    public ChainBarTest(SubsystemTestSide side) {
//        this.side = side;
//    }
//    double barPos, inc;
//    Servo bar;
...
//            bar = hardwareMap.servo.get(ChainBarConstants._ChainBarLeft);
//        } else if (side == SubsystemTestSide.RIGHT) {
//            bar = hardwareMap.servo.get(ChainBarConstants._ChainBarRight);
//        }
//        barPos = 0.5;
//        inc = 0.05;
//    }
